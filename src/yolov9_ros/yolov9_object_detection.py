...
from yolov9_msgs.msg import Bbox, BboxList
...
WEIGHTS_PATH = os.path.join(PKG_SHARE, "best.pt")
CLASS_AVERAGES_PATH = os.path.join(PKG_SHARE, "class_averages.yaml")
SUPPRESSED_CLASSES_PATH = os.path.join(PKG_SHARE, "suppressed_classes.yaml")
