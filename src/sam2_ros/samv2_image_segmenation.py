...
sam2_share = get_package_share_directory("sam2_ros")
segment_anything_dir = os.path.join(sam2_share, "segment-anything-2")
if segment_anything_dir not in sys.path:
...
from perception_common.utils import inverse_rigid_transform, timer
...
# Load SAM2 model
checkpoints_dir = os.path.join(segment_anything_dir, "checkpoints")
